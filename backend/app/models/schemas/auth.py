...
from app.models.enums import ChatScopeMode, HomeTab, ThemePreference
...
class TokenResponse(BaseModel):
    ...
    Attributes:
        access_token (str): The JWT access token (short-lived).
        refresh_token (str): The JWT refresh token (longer-lived).

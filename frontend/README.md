...
The frontend is a modern, high-performance web application designed for interacting with the Agentic RAG system. It features a sleek dark-mode UI, real-time streaming chat, and comprehensive document management.
